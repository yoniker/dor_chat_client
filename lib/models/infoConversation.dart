...
class InfoConversation{
  ...
  InfoConversation({required this.conversationId,required this.lastChangedTime,required this.creationTime,required this.participants,required this.messages});
